...
public class GetListModelQuery : IRequest<GetListResponse<GetListModelListItemDto>>
{
    ...
    public class GetListModelQueryHanlder : IRequestHandler<GetListModelQuery, GetListResponse<GetListModelListItemDto>>
    {
        private readonly IModelRepository _modelRepository;
        private readonly IMapper _mapper;
        public GetListModelQueryHanlder(IModelRepository modelRepository, IMapper mapper)
        {
